...
class AccountController extends AbstractController
{
    ...
    {
        return $this->render('professor/account/show.html.twig');
    }
    ...
    public function edit(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('professor_account_show');
        }

        return $this->render('professor/account/edit.html.twig', [
    ...
    public function changePassword(Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $passwordEncoder): Response
    {
        ...
        return $this->render('professor/account/change_password.html.twig', [
            'form' => $form->createView()
        ]);
    }
}
